...
export default function Dashboardpage() {
  ...
  return (
    // <main className=" w-full h-screen bg-[#ebe8e8] overflow-y-auto ">
    <section className="flex-1 flex justify-center overflow-y-auto bg-[#ebe8e8] mt-4 w-full pb-24">
      <div className="w-full max-w-md space-y-4 p-4">
        <div className="bg-[#ffffff] flex flex-col items-center mx-auto w-full max-w-md rounded-md shadow-xl">
          <ProfileCard
            profile={profile}
            ...
            onSettingsClick={() => {
              if (isMobile) {
                setIsSettingOpen(true); // buka dialog
              } else {
                setIsSettingOpen(true); // buka drawer
              }
            }}
