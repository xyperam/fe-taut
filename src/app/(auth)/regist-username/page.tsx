...
export default function RegistUsernamepage(){
    return (
       <main className="flex flex-col md:flex-row items-center justify-between p-24 h-screen">
        ...
        <InputWithPrefix  prefix="tautin.id/" type="text" placeholder="Username"  />
          <Button type="submit" className="bg-blue-500 text-white p-2 h-10">Next</Button>
        </form>
       <p className="mt-8">Already have account?
           <a href="/register" className="text-blue-500 hover:underline">Sign in!</a>
       </p>
        </section>
